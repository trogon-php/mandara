...
class StudentService extends BaseService
{
    ...
    protected int $roleId = Role::CLIENT->value;
    ...
    public function getFilterConfig(): array
    {
        return [
            ...
            'course_id' => [
                ...
                'col' => 3,
                'relation' => 'enrolledCourses',
                'relation_field' => 'courses.id',
    ...
    /**
     * Override getFilteredData to filter only students (role_id = 2)
     */
    public function getFilteredData(array $params = [])
    {
        $query = $this->model->where('role_id', $this->roleId)
            ->with(['enrolledCourses' => function($query) {
                $query->select('courses.id', 'courses.title', 'courses.status')
    ...
    /**
     * Override find to ensure we only find students
     */
    ...
    /**
     * Override delete to ensure we only delete students
     */
    ...
    /**
     * Override bulkDelete to ensure we only delete students
     */
    ...
    /**
     * Get students options for dropdowns
     */
