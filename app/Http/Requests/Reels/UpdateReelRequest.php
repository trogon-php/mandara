...
class UpdateReelRequest extends BaseRequest
{
    public function rules(): array
    {
        return [
            ...
            'video' => 'sometimes|required|file|mimes:mp4,avi,mov,wmv,flv,webm|max:30720', // 30MB max
            'reel_category_id' => 'nullable|integer|exists:reel_categories,id',
            'status' => 'sometimes|required|in:0,1',
            'premium' => 'sometimes|required|in:0,1',
