...
use App\Http\Requests\EstoreCategories\StoreEstoreCategoryRequest as StoreRequest;
use App\Http\Requests\EstoreCategories\UpdateEstoreCategoryRequest as UpdateRequest;
use App\Services\Estore\EstoreCategoryService;
use Illuminate\Http\Request;

class EstoreCategoryController extends AdminBaseController
{
    public function __construct(private EstoreCategoryService $service) {}
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.estore_categories.index', [
            'page_title' => 'EstoreCategory List',
    ...
    { 
        return view('admin.estore_categories.create'); 
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.estore_categories.edit', compact('edit_data'));
    }
    ...
    public function sortView()
    {
        ...
        return view('admin.estore_categories.sort', ['list_items'=>$list_items]);
    }
    ...
    public function cloneItem($id)
    {
        ...
        return $this->successResponse('Item cloned successfully.', [
            'action' => 'modal',
            'url' => route('admin.estore_categories.edit', $cloned->id)
        ]);
    }
}