...
class CourseTutorController extends AdminBaseController
{
    ...
    public function __construct(
        ...
        $this->middleware('can:course-tutors/index')->only('index');
        $this->middleware('can:course-tutors/create')->only(['create', 'store', 'cloneItem']);
        $this->middleware('can:course-tutors/edit')->only(['edit', 'update', 'sortView', 'sortUpdate']);
        $this->middleware('can:course-tutors/delete')->only('destroy', 'bulkDelete');
    }
