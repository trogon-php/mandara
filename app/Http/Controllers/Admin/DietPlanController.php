...
use App\Http\Requests\DietPlans\StoreDietPlanRequest as StoreRequest;
use App\Http\Requests\DietPlans\UpdateDietPlanRequest as UpdateRequest;
use App\Services\DietPlans\DietPlanService;
use Illuminate\Http\Request;

class DietPlanController extends AdminBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.diet_plans.index', [
            'page_title' => 'DietPlan List',
    ...
    {
        return view('admin.diet_plans.create');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.diet_plans.edit', compact('edit_data'));
    }
    ...
    public function sortView()
    {
        ...
        return view('admin.diet_plans.sort', ['list_items'=>$list_items]);
    }
    ...
    public function cloneItem($id)
    {
        ...
        return $this->successResponse('Item cloned successfully.', [
            'action' => 'modal',
            'url' => route('admin.diet_plans.edit', $cloned->id)
        ]);
    }
}