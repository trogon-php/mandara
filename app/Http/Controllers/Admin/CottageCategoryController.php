...
use App\Http\Requests\CottageCategories\StoreCottageCategoryRequest as StoreRequest;
use App\Http\Requests\CottageCategories\UpdateCottageCategoryRequest as UpdateRequest;
use App\Services\CottageCategories\CottageCategoryService;
use Illuminate\Http\Request;

class CottageCategoryController extends AdminBaseController
{
    public function __construct(private CottageCategoryService $service) {}
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.cottage_categories.index', [
            'page_title' => 'CottageCategory List',
    ...
    { 
        return view('admin.cottage_categories.create'); 
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.cottage_categories.edit', compact('edit_data'));
    }
    ...
    public function sortView()
    {
        ...
        return view('admin.cottage_categories.sort', ['list_items'=>$list_items]);
    }
    ...
    public function cloneItem($id)
    {
        ...
        return $this->successResponse('Item cloned successfully.', [
            'action' => 'modal',
            'url' => route('admin.cottage_categories.edit', $cloned->id)
        ]);
    }
}