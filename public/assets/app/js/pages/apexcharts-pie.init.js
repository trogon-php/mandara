...
var upadatedonutchart,
    ...
    chartDonutupdatingColors =
        (chartDonutBasicColors &&
            ((options = { series: [44, 55, 41, 17, 15], chart: { height: 300, type: "donut" }, legend: { position: "bottom" }, dataLabels: { dropShadow: { enabled: !1 } }, colors: chartDonutBasicColors }),
...
chartDonutupdatingColors &&
    ((options = { series: [44, 55, 13, 33], chart: { height: 280, type: "donut" }, dataLabels: { enabled: !1 }, legend: { position: "bottom" }, colors: chartDonutupdatingColors }),
...
var chart,
    ...
    chartPieImageColors =
        (chartPiePatternColors &&
            ((options = {
                series: [44, 55, 41, 17, 15],
                chart: { height: 300, type: "donut", dropShadow: { enabled: !0, color: "#111", top: -1, left: 3, blur: 3, opacity: 0.2 } },
                stroke: { width: 0 },
    ...
    options =
        (chartPieImageColors &&
            ((options = {
                ...
                fill: {
                    type: "image",
                    opacity: 0.85,
                    image: { src: ["./assets/images/small/img-1.jpg", "./assets/images/small/img-2.jpg", "./assets/images/small/img-3.jpg", "./assets/images/small/img-4.jpg"], width: 25, imagedHeight: 25 },
                },
                stroke: { width: 4 },
                dataLabels: { enabled: !0, style: { colors: ["#111"] }, background: { enabled: !0, foreColor: "#fff", borderWidth: 0 } },
                legend: { position: "bottom" },
            }),
            (chart = new ApexCharts(document.querySelector("#image_pie_chart"), options)).render()),
        {
            ...
            theme: { monochrome: { enabled: !0, color: "#405189", shadeTo: "light", shadeIntensity: 0.6 } },
