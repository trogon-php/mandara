    ...
    isbarchart =
        ((lineChartColor = getChartColorsArray("lineChart")) &&
            ...
            (lineChart = new Chart(islinechart, {
                ...
                options: { x: { ticks: { font: { family: "Poppins" } } }, y: { ticks: { font: { family: "Poppins" } } }, plugins: { legend: { labels: { font: { family: "Poppins" } } } } },
            }))),
    ...
    isdoughnutchart =
        ((pieChartColors = getChartColorsArray("pieChart")) &&
            (pieChart = new Chart(ispiechart, {
                type: "pie",
                data: { labels: ["Desktops", "Tablets"], datasets: [{ data: [300, 180], backgroundColor: pieChartColors, hoverBackgroundColor: pieChartColors, hoverBorderColor: "#fff" }] },
    ...
    ispolarAreachart =
        ((doughnutChartColors = getChartColorsArray("doughnut")) &&
            (lineChart = new Chart(isdoughnutchart, {
                type: "doughnut",
                data: { labels: ["Desktops", "Tablets"], datasets: [{ data: [300, 210], backgroundColor: doughnutChartColors, hoverBackgroundColor: doughnutChartColors, hoverBorderColor: "#fff" }] },
                options: { plugins: { legend: { labels: { font: { family: "Poppins" } } } } },
            })),
    ...
    isradarchart =
        ((polarAreaChartColors = getChartColorsArray("polarArea")) &&
            (lineChart = new Chart(ispolarAreachart, {
                type: "polarArea",
                data: { labels: ["Series 1", "Series 2", "Series 3", "Series 4"], datasets: [{ data: [11, 16, 7, 18], backgroundColor: polarAreaChartColors, label: "My dataset", hoverBorderColor: "#fff" }] },
                options: { plugins: { legend: { labels: { font: { family: "Poppins" } } } } },
            })),
