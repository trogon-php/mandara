...
!(function (t, e) {
    ...
    var $n = Object.freeze({
        ...
        BarController: class extends Ws {
            ...
            _getRuler() {
                ...
                return { min: a || Rn(e), pixels: s, start: i._startPixel, end: i._endPixel, stackCount: this._getStackCount(), scale: i, grouped: t.grouped, ratio: a ? 1 : t.categoryPercentage * t.barPercentage };
            }
    ...
    class mo extends Js {
        ...
        buildTicks() {
            ...
            const n = (function (t, e) {
                ...
                let D = 0;
                for (b && (u && M !== a ? (i.push({ value: a }), M < a && D++, V(Math.round((M + D * S) * v) / v, a, po(a, y, t)) && D++) : M < a && D++); D < k; ++D) {
                    const t = Math.round((M + D * S) * v) / v;
                    if (x && t > r) break;
                    i.push({ value: t });
                }
                return x && u && w !== r ? (i.length && V(i[i.length - 1].value, r, po(r, y, t)) ? (i[i.length - 1].value = r) : i.push({ value: r })) : (x && w !== r) || i.push({ value: w }), i;
            })(
                {
                    maxTicks: i,
                    bounds: t.bounds,
    ...
    function Mo(t, { min: e, max: i }) {
        ...
        for (; f < i; ) s.push({ value: f, major: yo(f), significand: u }), u >= 10 ? (u = u < 15 ? 15 : 20) : u++, u >= 20 && (o++, (u = 2), (a = o >= 0 ? 1 : a)), (f = Math.round((h + d + u * Math.pow(10, o)) * a) / a);
        const g = r(t.max, f);
    ...
    class wo extends Js {
        ...
        determineDataLimits() {
            ...
            (this.min = a(t) ? Math.max(0, t) : null),
                ...
                this._zero && this.min !== this._suggestedMin && !a(this._userMin) && (this.min = t === _o(this.min, 0) ? _o(this.min, -1) : _o(this.min, 0)),
                        ...
                        if (0 !== e) {
                            ...
                            !(function (t, e, i, s, n) {
                                ...
                                (!a && !s) ||
                                    ...
                                    !l ||
                                    i < 0 ||
                                    (o.save(), (o.strokeStyle = r), (o.lineWidth = l), o.setLineDash(n.dash), (o.lineDashOffset = n.dashOffset), o.beginPath(), To(t, i, a, s), o.closePath(), o.stroke(), o.restore());
                            })(this, a, r, o, l);
                        }
                    }),
                i.display)
    ...
    function ca(t, e, i) {
        ...
        s &&
            ...
            (function (t, e) {
                ...
                t.save(), "x" === l && o !== n && (da(t, s, a.top), ua(t, { line: i, target: s, color: n, scale: r, property: l }), t.restore(), t.save(), da(t, s, a.bottom));
                ...
                for (const t of s) {
                    ...
                    for (const e of h) {
                        const s = Qo(i, o[e.start], o[e.end], e.loop),
                            r = Ri(t, n, s);
                        for (const t of r) a.push({ source: t, target: e, start: { [i]: ea(l, s, "start", Math.max) }, end: { [i]: ea(l, s, "end", Math.min) } });
                    }
                }
                return a;
            })(i, s, n);
        ...
        afterDatasetsUpdate(t, e, i) {
            ...
            for (a = 0; a < s; ++a)
                (o = t.getDatasetMeta(a)),
                    (r = o.dataset),
                    (l = null),
                    r && r.options && r instanceof so && (l = { visible: t.isDatasetVisible(a), index: a, fill: oa(r, a, s), chart: t, axis: o.controller.options.indexAxis, scale: o.vScale, line: r }),
                    (o.$filler = l),
                    n.push(l);
    ...
    class Fa extends Hs {
        ...
        drawTitle(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = La(this, i.titleAlign, i), e.textAlign = l.textAlign(i.titleAlign), e.textBaseline = "middle", o = Si(i.titleFont), a = i.titleSpacing, e.fillStyle = i.titleColor, e.font = o.string, r = 0; r < n; ++r)
        ...
        drawFooter(t, e, i) {
            ...
            if (n) {
                ...
                for (t.x = La(this, i.footerAlign, i), t.y += i.footerMarginTop, e.textAlign = r.textAlign(i.footerAlign), e.textBaseline = "middle", o = Si(i.footerFont), e.fillStyle = i.footerColor, e.font = o.string, a = 0; a < n; ++a)
