        ...
        <tr>
            ...
            <td>
                @include('admin.crud.action-dropdown', [
                    'editUrl'     => url('admin/attendants/'.$list_item->id.'/edit'),
                    'editTitle'   => 'Update Attendant',
                    'showUrl'     => url('admin/attendants/'.$list_item->id),
                    'showTitle'   => 'View Attendant',
                    'deleteUrl'   => route('admin.attendants.destroy', $list_item->id),
