        ...
        <tr>
            ...
            <td>
                @include('admin.crud.action-dropdown', [
                    'editUrl'     => url('admin/clients/'.$list_item->id.'/edit'),
                    'editTitle'   => 'Update Client',
                    'showUrl'     => url('admin/clients/'.$list_item->id),
                    'showTitle'   => 'View Client',
                    'deleteUrl'   => route('admin.clients.destroy', $list_item->id),
