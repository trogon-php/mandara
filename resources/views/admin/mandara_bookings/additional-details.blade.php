                ...
                >
                   ...
                   {{-- ================= ADDITIONAL NOTES & EMERGENCY CONTACT ================= --}}
                    ...
                    @php
                        ...
                        $motherHealthQuestionIds = [61, 62, 63, 64, 65]; 
                    @endphp
                ...
                <div id="section-c" class="d-none">
                    ...
                    @endforeach
                                    ...
                                    <div class="text-end mt-4 d-flex justify-content-end gap-2">
                                        ...
                                        {{-- APPROVE & SUBMIT (ONLY FOR APP BOOKING + PENDING) --}}
                                        @if($booking->is_app_booking && $booking->approval_status === 'pending')
                                        <button type="submit"
                                                formaction="{{ route('admin.mandara-bookings.approve', $booking->id) }}"
      ...
      console.log(sectionC);
        ...
        function toggleSections(value) {
            ...
            if (value.includes('before')) {
                ...
                sectionC.classList.add('d-none');
            } 
            else if (value.includes('after')) {
              
                sectionB.classList.add('d-none');
                sectionC.classList.remove('d-none');
            }
            else {
