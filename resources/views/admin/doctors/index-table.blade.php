        ...
        <tr>
            ...
            <td>
                @include('admin.crud.action-dropdown', [
                    'editUrl'     => url('admin/doctors/'.$list_item->id.'/edit'),
                    'editTitle'   => 'Update Doctor',
                    'showUrl'     => url('admin/doctors/'.$list_item->id),
                    'showTitle'   => 'View Doctor',
                    'deleteUrl'   => route('admin.doctors.destroy', $list_item->id),
