        ...
        <tr>
            ...
            <td>
                @include('admin.crud.action-dropdown', [
                    'editUrl'     => url('admin/food-delivery-staff/'.$list_item->id.'/edit'),
                    'editTitle'   => 'Update Food Delivery Staff',
                    'showUrl'     => url('admin/food-delivery-staff/'.$list_item->id),
                    'showTitle'   => 'View Food Delivery Staff',
                    'deleteUrl'   => route('admin.food-delivery-staff.destroy', $list_item->id),
                    'redirectUrl' => route('admin.food-delivery-staff.index')
                ])
            </td>
        </tr>
    @endforeach
