@include('admin.crud.form', [
    'action' => route('admin.food-delivery-staff.update', $edit_data->id),
    'method' => 'PUT',
    'formId' => 'edit-fooddeliverystaff-form',
    'submitText' => 'Update Food Delivery Staff',
    'class'      => 'ajax-crud-form',
    'redirect'   => route('admin.food-delivery-staff.index'),
    'fields' => [
        [
            'type' => 'text',
            'name' => 'name',
