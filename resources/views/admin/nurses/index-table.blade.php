    ...
    @foreach ($list_items as $list_item)
        <tr>
            ...
            <td>
                <div>
                   <small>
                    @if($list_item->specialization == 'maternity_care')
                        Maternity Care
                    @elseif($list_item->specialization == 'baby_care')
                        Baby Care
                    @else
                        N/A
                    @endif
            ...
            <td>
                <div>
                    <small>{{ $list_item->qualification }}</small>
                </div>
            </td>
            <td>
                <div>
                    <small>{{ $list_item->blood_group }}</small>
                </div>
            </td>
            <td>
                <div>
                    <small> {{
                        $list_item->date_of_birth
                            ? \Carbon\Carbon::parse($list_item->date_of_birth)->format('d-m-Y')
                            : 'N/A'
                    }}</small>
                </div>
            </td>
            <td>
                <div>
                    <small> {{
                        $list_item->joining_date
                            ? \Carbon\Carbon::parse($list_item->joining_date)->format('d-m-Y')
                            : 'N/A'
                    }}</small>
                </div>
            </td>
            ...
            <td>
                @include('admin.crud.action-dropdown', [
                    'editUrl'     => url('admin/nurses/'.$list_item->id.'/edit'),
                    'editTitle'   => 'Update Nurse',
                    'showUrl'     => url('admin/nurses/'.$list_item->id),
                    'showTitle'   => 'View Nurse',
                    'deleteUrl'   => route('admin.nurses.destroy', $list_item->id),
