        ...
        <tr>
            ...
            <td>
                @include('admin.crud.action-dropdown', [
                    'editUrl'     => url('admin/estore-delivery-staff/'.$list_item->id.'/edit'),
                    'editTitle'   => 'Update Estore Delivery Staff',
                    'showUrl'     => url('admin/estore-delivery-staff/'.$list_item->id),
                    'showTitle'   => 'View Estore Delivery Staff',
                    'deleteUrl'   => route('admin.estore-delivery-staff.destroy', $list_item->id),
                    'redirectUrl' => route('admin.estore-delivery-staff.index')
                ])
            </td>
        </tr>
    @endforeach
